...
namespace EEngine::Rendering {
	...
	void Renderer::BeginScene(const Math::mat4& projectionView) const {
		m_Data.TextureShader->Bind();
	...
	void Renderer::DrawQuad(const Math::vec3& position, const Math::vec2& size, const Math::vec4& color) const {
	...
	void Renderer::DrawQuad(const Math::vec2& position, const Math::vec2& size, const Math::vec4& color) const {
		DrawQuad({position.x, position.y, 0.0f}, size, color);
	}

	void Renderer::DrawQuad(const Math::vec3& position, const Math::vec2& size, const Shared<Texture2D>& texture) const {
		using namespace Math;
	...
	void Renderer::DrawQuad(const Math::vec2& position, const Math::vec2& size, const Shared<Texture2D>& texture) const {
